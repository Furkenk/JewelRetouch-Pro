      ...
      >
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <input type="text" placeholder={t.profile.personalInfo} defaultValue="Furkan Daldal" className={`w-full py-3 px-4 rounded-xl text-sm ${isDarkMode ? 'bg-slate-800 text-white border-slate-700' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:outline-none`} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input type="email" placeholder={t.profile.registrationInfo} defaultValue="furkandaldal1@gmail.com" className={`w-full py-3 px-4 rounded-xl text-sm ${isDarkMode ? 'bg-slate-800 text-white border-slate-700' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:outline-none`} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <select className={`w-full py-3 px-4 rounded-xl text-sm ${isDarkMode ? 'bg-slate-800 text-white border-slate-700' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:outline-none`}>
              <option>{t.profile.professions.jeweler}</option>
              <option>{t.profile.professions.designer}</option>
              <option>{t.profile.professions.photographer}</option>
              <option>{t.profile.professions.other}</option>
            </select>
          </div>
