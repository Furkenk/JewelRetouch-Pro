      ...
      `}>
        ...
        {imageState.preview ? (
          ...
          <label htmlFor={`upload-${label}`} className="w-full h-full flex flex-col items-center justify-center cursor-pointer p-6">
            ...
            <span className="text-sm text-gray-400 dark:text-slate-500 group-hover:text-black dark:group-hover:text-white transition-colors font-medium">{t.common.clickUpload}</span>
          </label>
        )}
      </div>
    </div>
